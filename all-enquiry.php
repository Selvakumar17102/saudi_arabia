		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row" style="width: 100%">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title">Total Enquiry</h4>
					</div>
					<div class="col-sm-1">
                    	        ...
                    	        <table id="example1" class="display" cellspacing="0" width="100%">
									...
									<tbody>
										<?php
											...
											if($sdate =="" || $end_date == "")
											{
												$sql1 = "SELECT * FROM enquiry WHERE new_status='1'";
											}else{
												$sql1 = "SELECT * FROM enquiry WHERE new_status='1' AND enqdate BETWEEN '$sdate' AND '$end_date'";
											}
