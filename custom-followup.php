<?php
    ...
    if(isset($_POST["search"]))
    {
        ...
        header("Location: custom-followup.php?fdate=$fd&ldate=$td");
    }
                            ...
                            <form method="post" class="edit-profile">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 course">
                                        <input class="form-control" type="date" name="fd" value="<?php echo $fd ?>" required>
                                    </div>
                                    <label class="col-sm-2 col-form-label">To Date</label>
                                    <div class="col-sm-3 course">
                                        <input class="form-control" type="date" name="td" value="<?php echo $td ?>" required>
                                    </div>
                                    <div class="col-sm-2">
