                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            for($i=0;$i < $array_count;$i++)
                                            {
                                                ...
                                                $overall_invoice_value = $overall_collected_value = $overall_due = 0;
                                                while($row = $result->fetch_assoc())
                                                {
                                                    $eid = $row["eid"];
                                                    $pid = $row["id"];
                                                    ...
                                                    $sql12 = "SELECT * FROM invoice WHERE pid='$proid' ORDER BY date ASC";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><center><?php echo number_format($overall_due,2);?></center></td>
                                                    </tr>
                                                <?php
