		...
		<div class="container-fluid">
			...
			<div class="db-breadcrumb">
				<div class="row r-p100">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title"><?php echo ucfirst(strtolower($div)).' Division' ?></h4>
					</div>
									...
									<tbody>
										<?php
											...
											while($row = $result->fetch_assoc())
											{
												...
												if($scope_type == 1)
												{
													$sql4 = "SELECT * FROM scope_list WHERE id='$scope_id'";
												...
												{
													$sql4 = "SELECT * FROM scope WHERE eid='$eid'";
													$result4 = $conn->query($sql4);
													if($result4->num_rows > 0)
													{
										...
										?>
												<tr>
													...
													<td><a href="over-all-statement.php?id=<?php echo rawurlencode(urlencode($row['cname']));?>"><?php echo $row["cname"] ?></a></td>
