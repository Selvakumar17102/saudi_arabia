                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><center><?php $current_row1 = $row1["current"]; if($current_row1 == " "){$current_row1 = 0;} echo number_format($current_row1,2) ;?></center></td>
                ...
                <div id="invoice_table" style="padding-top:60px;">
                    <table>
                        <thead>
                            ...
                            <tr>
                                <th><center>Over All Invoiced Amount</center></th>
                                <th><center>Over All Invoiced VAT Amount</center></th>
                                <th><center>Over All Received Amount</center></th>
                                <th><center>Over All Received VAT Amount</center></th>
                                <th><center>Over All Pending Amount</center></th>
                                <th><center>Over All Pending VAT Amount</center></th>
                                <th><center>Over All Due Amount</center></th>
                                <th><center>Over All Due VAT Amount</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
