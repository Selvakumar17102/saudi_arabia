...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="GST Reports | Project Management System" />
	
	<!-- OG -->
	<meta property="og:title" content="GST Reports | Project Management System" />
	<meta property="og:description" content="GST Reports | Project Management System />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>GST Reports | Project Management System</title>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row r-p100">
					...
					<div class="col-sm-11">
						<h4 class="breadcrumb-title"><h5><?php echo $division;?>- GST Reports </h5></h4>
					</div>
					<div class="col-sm-1">
						<a  href="gst-reports.php" style="color: #fff" class="bg-primary btn">Back</a>
					</div>
                    ...
                    ?>
                         <form action="gst_reports_details.php?division='<?php $_REQUEST['division'];?>'" method="get">
				...
				<div class="col-lg-4">
					<div class="widget-card widget-bg1">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
                            <?php 
                                $i_gst_sql = "SELECT sum(demo_gst) AS demo_gst  FROM invoice WHERE monthname(subdate)='$month' AND divi = '$division' AND paystatus != ''";
                                $i_gst_result = $conn->query($i_gst_sql);
                                $i_gst_row = mysqli_fetch_array($i_gst_result);
                                echo number_format($i_gst_row['demo_gst'],2)."₹";
                                ?>
							</span>		
                ...
                <div class="col-lg-4">
					<div class="widget-card widget-bg2">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
                            <?php 
                                $t_gst_sql = "SELECT sum(current_gst) AS current_gst  FROM invoice WHERE monthname(recdate)='$month' AND divi = '$division' AND paystatus != 0";
                                $t_gst_result = $conn->query($t_gst_sql);
                                $t_gst_row = mysqli_fetch_array($t_gst_result);
                                echo number_format($t_gst_row['current_gst'],2)."₹";
                                ?>
							</span>		
						...
						<div class="wc-item">
							...
							<span class="wc-stats">
                                ...
                                // echo $date; 
                                    ...
                                    $d_gst_sql = "SELECT SUM(demo_gst) AS total,SUM(current_gst) AS collected  FROM invoice WHERE (divi = '$division') AND (monthname(due_date)='$month') AND (DATE(due_date) < DATE(NOW()));";
                            ...
                            <table id="dataTableExample1" class="table table-striped">
                                    <thead>
                                        <tr>
											...
											<th><center>Recived GST Value</center></th>
                                        </tr>	
                                    </thead>
									<tbody>
                                            <?php
                                        ...
                                        <tr>
                                            ...
                                            <!--==================Recived Name ===========================--->
                                                    ...
                                                    ?>
                                            <td><center><?php echo number_format($row0['current_gst'],2);?>₹</center></td> <!-- Gst Value  --->
