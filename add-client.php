<?php
    ...
    if(isset($_POST["add"]))
    {
        ...
        {
            $sql1 = "INSERT INTO main (name) VALUES ('$name')";
            if($conn->query($sql1) === TRUE)
            {
                header("Location: add-client.php?msg=Client Added!");
            }
        }
    }
?>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb" style="margin-bottom: 0px;padding-bottom: 0px">
				<div class="row" style="width: 100%">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title">Add Client</h4>
					</div>
				</div>
			</div>	
                    	        ...
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
                                            ...
                                            $sql1 = "SELECT * FROM main ORDER BY name ASC";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <?php 
                                                        if($row1["user"] != "")
                                                        {
                                                            echo $row1["user"].'<br>'.date('d-m-Y | h:i:s a',strtotime($row1["datetime"])); 
                                                        }
                                                        else
                                                        {
                                                            echo "-";
                                                    ...
                                                    <?php
                                                        if($control != "2" && $control != "4" && $control != "5"){
                                                            ?>
                                                                <td>
                                                                    <center>
                                                                        <a href="edit-client.php?id=<?php echo $row1["id"] ?>" title="Edit"><span class="notification-icon dashbg-yellow"><i class="fa fa-pencil" aria-hidden="true"></i></span></a>
                                                                    </center>
                                                                </td>
                                                            <?php
                                                        }
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a href="view-project-list.php?id=<?php echo rawurlencode(urldecode($row1["name"]));?>">-></a>
                                                        </center>
                                                    </td>
                                                </tr>
                                        <?php
