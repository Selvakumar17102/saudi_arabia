...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Invoice History | Project Management System</title>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row r-p100">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title"><?php echo $project ?> Projects - <?php echo $invoice_id;?></h4>
					</div>
					<div class="col-sm-1">
                        ...
                        <div class="card-content">
                            <div class="table-responsive col-lg-12">
								<table id="dataTableExample1" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM invoice_history WHERE invoice_id='$id'";
                                            $result = $conn->query($sql);
                                            $i = 1;
                                            while ($row = $result->fetch_assoc()) {
                                                $inv_id = $row['invoice_id'];

                                                $sql1 = "SELECT * FROM invoice WHERE id='$inv_id'";
                                                $result1 = $conn->query($sql1);
                                                $row1 = $result1->fetch_assoc();
                                                ?>
                                                    <tr>
                                                        <td><center><?php echo $i++;?></center></td>
                                                        <td><center><?php echo $row1['invdoc'];?></center></td>
                                                        <td><center><?php echo $row['amount'];?></center></td>
                                                        <td><center><?php echo date('Y-m-d', strtotime($row['date']));?></center></td>
                                                    </tr>
                                                <?php
                                            }
                                        ?>
