				...
				<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
					<a href="client.php" title="View Today Quatation"><div class="widget-card widget-bg2">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								<?php $tot1 = "SELECT * FROM enquiry where pstatus='FOLLOW UP' AND new_status='1'";
				...
				<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
					<a href="client.php" title="View Week Quatation"><div class="widget-card widget-bg3">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								<?php $tend1 = "SELECT * FROM enquiry WHERE pstatus = 'FOLLOW UP' AND new_status='1' AND qdatec BETWEEN '$date' AND '$date' + interval 7 day";
				...
				<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
					<a href="lost.php" title="View Lost"><div class="widget-card widget-bg2">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								<?php $jobin1 = "SELECT * FROM enquiry WHERE pstatus = 'LOST' AND new_status='1'";
				...
				<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
					<a href="all-projects.php" title="View Awarded"><div class="widget-card widget-bg3">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								<?php 
										$drop = "SELECT * FROM enquiry WHERE pstatus = 'AWARDED' AND new_status='1'";
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                for($i=0;$i < count($division);$i++)
                                                {
                                                    ...
                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND qstatus='SUBMITTED' AND stage='Tender' AND qdatec BETWEEN '$starting_date' AND '$ending_date' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    $This_Month_Proposal_Tenders = $result1->num_rows;

                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND qstatus='SUBMITTED' AND stage='Job In Hand' AND qdatec BETWEEN '$starting_date' AND '$ending_date' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    $This_Month_Proposal_Job_In_Hand = $result1->num_rows;

                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND  stage='Tender' AND pstatus='FOLLOW UP' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    $Total_FollowUp_Tenders = $result1->num_rows;

                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND stage='Job In Hand' AND pstatus='FOLLOW UP' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    ...
                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND pstatus='AWARDED' AND qdatec BETWEEN '$starting_date' AND '$ending_date' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    $Month_Total_Award = $result1->num_rows;

                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND pstatus='LOST' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
                                                    $Total_Lost = $result1->num_rows;

                                                    $sql1 = "SELECT * FROM enquiry WHERE rfq='$my_division' AND pstatus='LOST' AND qdatec BETWEEN '$starting_date' AND '$ending_date' AND new_status='1'";
                                                    $result1 = $conn->query($sql1);
