		...
		{	
			if($row1["pterms"] == 2)
			{
				...
				// {
					...
					{
						$sql5 = "INSERT INTO invoice (invid,rfqid,term,total,current,date,po,invdoc,month,demo) VALUES ('$invid','$rfqid','$term','$total','$current','$date','$po','$invdoc','$month12','$current')";
			...
			else
			{
				...
				else
				{
					...
					{
						$sql5 = "INSERT INTO invoice (invid,rfqid,term,total,current,date,po,invdoc,demo,month) VALUES ('$invid','$rfqid','$term','$total','$current','$date','$po','$invdoc','$current','$month12')";
						if($conn->query($sql5) === TRUE)
						{
							header("location: invoice.php?id=$id&msg=Invoice Generated Successfully!");
						}
						...
						<div class="">
							...
							<div class="form-group row" style="margin-top:30px">
								...
								<?php
										...
										{
								?>
									<label class="col-sm-1 col-form-label">Payment Trems</label>
									<div class="col-sm-2">
					...
					<div class="card">
                        ...
                        ?>
										...
										?>
												...
												<td><a href="delete-invoice.php?id=<?php echo $row["id"] ?>&mid=<?php echo $id ?>" title="Delete"><span class="notification-icon dashbg-red" onClick="return confirm('Sure to Delete this Invoice!');"><i class="fa fa-trash" aria-hidden="true"></i></span></a></td></tr></table></td>
											</form>
                                        </tr>
