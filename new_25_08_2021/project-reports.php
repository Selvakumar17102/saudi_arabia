	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			...
			<div class="row head-count m-b30">
				...
				<div class="col-lg-3">
					<a href="project-selected.php?id=1" title="Running Projects"><div class="widget-card widget-bg1">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Running
							</h4>
				...
				<div class="col-lg-3">
					<a href="project-selected.php?id=2" title="Commercially Open Projects"><div class="widget-card widget-bg2">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Commercially Open
							</h4>
				...
				<div class="col-lg-3">
					<a href="project-selected.php?id=3" title="Project Closed"><div class="widget-card widget-bg3">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Project Closed
							</h4>
				...
				<div class="col-lg-3">
					<a href="project-selected.php?id=4" title="Commercially Closed"><div class="widget-card widget-bg4">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Commercially Closed
							</h4>
                    	        ...
                    	        <table class="table table-striped" style="margin-bottom: 0;">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php if($sp != 0){ ?><a href="project-selected2.php?mid=1"><?php echo $sp+$sd ?></a><?php }else echo $sp ?></td>
											...
											<td><?php if($scl1 != 0){ ?><a href="project-selected.php?id=4&mid=1"><?php echo $scl1 ?></a><?php }else echo $scl1 ?></td>
										</tr>
										<tr>
											<th>Engineering Services</th>
											<td><?php if($ep != 0){ ?><a href="project-selected2.php?mid=2"><?php echo $ep+$ed ?></a><?php }else echo $ep ?></td>
											...
											<td><?php if($ecl1 != 0){ ?><a href="project-selected.php?id=4&mid=2"><?php echo $ecl1 ?></a><?php }else echo $ecl1 ?></td>
										</tr>
										<tr>
											<th>Simulation & Analysis Services</th>
											<td><?php if($sap != 0){ ?><a href="project-selected2.php?mid=3"><?php echo $sap+$sad ?></a><?php }else echo $sap ?></td>
											...
											<td><?php if($sacl1 != 0){ ?><a href="project-selected.php?id=4&mid=3"><?php echo $sacl1 ?></a><?php }else echo $sacl1 ?></td>
										</tr>
										<tr>
											<th>Deputation</th>
											<td><?php if($lp != 0){ ?><a href="project-selected2.php?mid=4"><?php echo $lp+$ld ?></a><?php }else echo $lp ?></td>
											...
											<td><?php if($lcl1 != 0){ ?><a href="project-selected.php?id=4&mid=4"><?php echo $lcl1 ?></a><?php }else echo $lcl1 ?></td>
										</tr>
