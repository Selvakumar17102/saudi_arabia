		...
		<div class="container-fluid">
							...
							<form class="edit-profile m-b30" method="post" enctype="multipart/form-data">
								<div class="m-b30">
									...
									<div class="form-group row">
										...
										<label class="col-sm-2 col-form-label de">Number of Months</label>
										...
										<label style="color: black;" class="col-sm-4 col-form-label">QAR <?php echo number_format($row["value"],2) ?></label>
			...
			<div class="row">
                <div class="col-sm-12 m-b30">
                    	<?php
							$sql = "SELECT * FROM invoice WHERE pid='$pid' AND current!='0' AND paystatus!='0' ORDER BY recdate DESC";
							$result = $conn->query($sql);
						...
						<div class="widget-box" style="height: auto !important">
							<div class="card-header">
								<div class="row">
									<div class="col-sm-6">
										<label class="col-form-label">Total Invoiced value : QAR <?php echo number_format($demo,2) ?></label>
									</div>
									<div class="col-sm-6">
										<label class="col-form-label float-right">Total Recieved value : QAR <?php echo number_format($cur,2) ?></label>
									</div>
								</div>
							</div>
							<div class="widget-inner">
							...
							{
								$sql = "SELECT * FROM invoice WHERE rfqid='$rfqid' AND current!='0' AND paystatus='2' ORDER BY recdate DESC";
								$result = $conn->query($sql);
								$count = 1;
								if($result->num_rows > 0)
								{
