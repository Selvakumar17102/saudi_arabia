                            ...
                            <div class="table-responsive">
                    	        <table id="dataTableExample" class="table table-striped" style="border:0px solid black;">
									...
									<tbody>
										...
										<?php
											$sql1 = "SELECT * FROM invoice WHERE rfqid='$rfqid' AND date<='$today' AND current!='0' ORDER BY date ASC";
											$result1 = $conn->query($sql1);
											$count = 1;
										...
										?>
												...
												<tr style="border-bottom: 1px solid #000;">
													...
													<?php
														...
														{
													?>
													<td class="hide"><center><a href="edit-entry.php?id=<?php echo $row1["id"]."&enq=".$id ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></center></td>
													<?php
														}
													?>
												</tr>
										...
										<thead>
											...
											<tbody>
											<tr>
												<td><center>QAR <?php echo number_format($amo1,2) ?></center></td>																								
												<td><center>QAR <?php echo number_format($amo2,2) ?></center></td>
												<td><center>QAR <?php echo number_format($pend,2) ?></center></td>
												<td><center>QAR <?php echo number_format($tot,2) ?></center></td>
											</tr>									
									</tbody>
                                </table>
                            </div>
