                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
											$sql1 = "SELECT * FROM enquiry WHERE qstatus = 'DROPPED'";
											...
											while($row1 = $result1->fetch_assoc())
											{
												...
												{
												?>
													<td><table><tr><td style="text-align: center;"><a href="delete-enquiry.php?id=<?php echo $row1["id"]; ?>" onClick="return confirm('Sure to Delete this Enquiry !');"><i class="fa fa-trash" aria-hidden="true"></i></a></td></tr></table></td>
												<?php
												}
												echo '</tr>';
												$count++;
