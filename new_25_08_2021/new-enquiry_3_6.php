<?php
    ...
    if(isset($_POST['save']))
    {
		...
		$sql = "INSERT INTO enquiry (rfq,rfqid,name,location,enqdate,stage,cname,responsibility,qstatus,qdate,revision,notes,division,cid,scope_id) VALUES ('$rfq','$rfqid','$name','$location','$enqdate','$stage','$cname','$responsibility','$qstatus','$qdate','$revision','$notes','$division','$cid','$scope')";
