<?php
	...
	$sql = "SELECT * FROM invoice WHERE recdate BETWEEN '$thismonth' AND '$today' AND paystatus=2 ORDER BY recdate ASC";
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Consolidate Recieved Reports | Project Management System</title>
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Consolidate Recieved Reports</h4>
			</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b30 m-t30">
                    <div class="widget-box">
						<div class="card-header">
							<div class="row">
								<div class="col-sm-8">
									<h4 style="float: left !important"><?php echo ucfirst(strtolower($div2)) ?> - Invoice Recieved Reports</h4>
								</div>
								<div class="col-sm-4">
...
<script>
	function boss(val)
	{
		if(val != "")
		{
			location.replace("consolidate-recieved.php?mid=<?php echo $mid ?>&id="+val);
		}
	}
	function search()
	{
		...
		else
		{
			...
			{
				location.replace("consolidate-recieved.php?mid=<?php echo $mid ?>&fdate="+fdate+"&tdate="+tdate);
			}
		}
	}
</script>
