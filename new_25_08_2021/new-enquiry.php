<?php
    ...
    if(isset($_POST['save']))
    {
		...
		$sql2 = "SELECT * FROM enquiry WHERE enqdate > '2020-12-31'";
		...
		$sql = "INSERT INTO enquiry (rfq,rfqid,name,location,enqdate,stage,cname,responsibility,qstatus,qdate,revision,notes,division,cid,scope) VALUES ('$rfq','$rfqid','$name','$location','$enqdate','$stage','$cname','$responsibility','$qstatus','$qdate','$revision','$notes','$division','$cid','$scope')";
...
<script>
	...
	$('#add').click(function(){
			i++;
           $('#duplicate').append(
			   '<div class="form-group row" id="duplicate'+i+'"><div class="col-sm-2"></div><div class="col-sm-4"><input class="form-control" type="text" name="o_scope[]"></div><div class="col-sm-2"><button type="button" name="remove" class="btn btn-danger btn_remove" id="'+i+'">X</button></div></div>');
      });  
