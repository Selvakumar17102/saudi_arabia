				...
				<div class="col-sm-4 m-b10">
					<div class="widget-card widget-bg1">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								Total Enquiry : <?php echo $result->num_rows ?> <br>Submitted Enquiry : <?php echo $sub ?>
							</span>		
				...
				<div class="col-sm-4 m-b10">
					<div class="widget-card widget-bg2">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								Total Proposal : <?php echo $sub ?><br>Awarded Proposal : <?php echo $award ?>
							</span>		
				...
				<div class="col-sm-4">
					<div class="widget-card widget-bg3">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
								Total Projects : <?php echo $result1->num_rows ?><br>Commercially Opened : <?php echo $co ?>
							</span>		
					    ...
					    <div class="row">
    					    <div class="col-sm-4">
        						<div class="wc-item text-center">
        							...
        							<span class="wc-stats">
        								PO Value : QAR <?php echo number_format($value,2); ?>
        							</span>
        						</div>
    						</div>
    						<div class="col-sm-4">
        						<div class="wc-item text-center">
        							...
        							<span class="wc-stats">
        								Invoiced Value : QAR <?php echo number_format($inv,2); ?>
        							</span>
        						</div>
    						</div>
    						<div class="col-sm-4">
        						<div class="wc-item text-center">
        							...
        							<span class="wc-stats">
        								Collection Value : QAR <?php echo number_format($coll,2); ?>
        							</span>
        						</div>
    						</div>
    					</div>
