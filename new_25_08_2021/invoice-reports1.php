		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				...
				<div class="col-sm-9 right">
					<a href="custom-invoice.php" style="color: #fff" class="bg-primary btn">Custom Search</a>
				</div>
									...
									<tbody>
										<?php
											...
											while($row2 = $result2->fetch_assoc())
											{
												...
												$sql4 = "SELECT sum(current) as current FROM invoice WHERE rfqid='$rfqid' AND recdate!='$dates'";
										...
										?>
											<tr>
												...
												{
													echo '<td><center>'.$row4["current"].'</center></td>';
												}
												?>
												<td><center><?php echo $value-$row4["current"] ?></center></td>
											</tr>
										<?php
											}
										?>
									...
									<tbody>
										<?php
											...
											while($row5 = $result5->fetch_assoc())
											{
												...
												$sql7 = "SELECT sum(current) as current FROM invoice WHERE rfqid='$rfqs' AND recdate!='$dates'";
										...
										?>
											<tr>
												...
												<td><center><?php echo $sp ?></center></td>
												<td><center><?php echo $st-$sp ?></center></td>
											</tr>
											<tr>
												<td><center> 2 </center></td>
												<td><center>ENGINEERING SERVICES</center></td>
												<td><center><?php echo $et ?></center></td>
												<td><center><?php echo $ep ?></center></td>
												<td><center><?php echo $et-$ep ?></center></td>
											</tr>
											<tr>
												<td><center> 3 </center></td>
												<td><center>SIMULATION & ANALYSIS SERVICES</center></td>
												<td><center><?php echo $sat ?></center></td>
												<td><center><?php echo $sap ?></center></td>
												<td><center><?php echo $sat-$sap ?></center></td>
											</tr>
											<tr>
												<td><center> 4 </center></td>
												<td><center>LASER SCANNING SERVICES</center></td>
												<td><center><?php echo $lt ?></center></td>
												<td><center><?php echo $lp ?></center></td>
												<td><center><?php echo $lt-$lp ?></center></td>
											</tr>
