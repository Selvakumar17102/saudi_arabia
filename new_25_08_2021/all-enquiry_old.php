										...
										<table id="example" class="display div2" cellspacing="0" width="100%">
											...
											<tbody>
												<?php
													...
													if($from!="" && $to!="")
													{
														$sql1 = "SELECT * FROM enquiry WHERE enqdate BETWEEN '$from' AND '$to' AND pstatus!='$award' ORDER BY qdate ASC";
													}else{
														$sql1 = "SELECT * FROM enquiry WHERE pstatus!='$award' ORDER BY qdate ASC";
													}
