	...
	if(isset($_POST["pay"]))
	{
		...
		{	
			if($row1["pterms"] == 2)
			{
				...
				$sql10 = "SELECT * FROM invoice WHERE term='2' AND rfqid='$rfqid' AND date BETWEEN '$start' AND '$end'";
...
<body class="ttr-pinned-sidebar" onload="datefun()">
