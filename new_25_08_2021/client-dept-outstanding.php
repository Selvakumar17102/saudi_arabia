                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td><center><a href="client-outstanding.php?id=<?php echo $row["id"] ?>"><?php echo $row["name"] ?></a></center></td>
...
<script>
    function boss(val)
	{
		if(val != "")
		{
			location.replace("https://www.conserveacademy.com/projectmgmttool/invoice-due1.php?id="+val);
