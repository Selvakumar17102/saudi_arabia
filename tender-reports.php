...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Tender Enquiry | Project Management System</title>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row r-p100">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title">Tender Enquiry</h4>
					</div>
					<div class="col-sm-1">
                    	        ...
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
											...
											{
												$sql1 = "SELECT * FROM enquiry WHERE stage = 'Tender' AND new_status='1' ORDER BY enqdate DESC";
											}else{
												$sql1 = "SELECT * FROM enquiry WHERE stage = 'Tender' AND new_status='1' AND enqdate BETWEEN '$start_date' AND '$end_date' ORDER BY enqdate DESC";
											}
