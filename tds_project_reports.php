	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				...
				<div class="col-sm-9">
						<h4 class="breadcrumb-title" style="text-align: center;color: #214597;font-size: 30px;font-weight: bold;padding-left:400px;"><center><h4>Invoice wise TDS breakup  </h4></center></h4>
				...
				<div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 col-6">
					<div class="widget-card widget-bg2">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
                            ₹ <?php
                                    $total_gst_sql = "SELECT sum(demo_tds) AS total_tds FROM invoice WHERE pid = '$project_id' AND paystatus !='0'";
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 col-6">
					<div class="widget-card widget-bg3">					 
						<div class="wc-item">
							...
							<span class="wc-stats">
                            ₹ <?php
                                    $recived_gst_sql = "SELECT sum(current_tds) AS resived_tds FROM invoice WHERE pid = '$project_id' AND paystatus = 2";
                                        ...
                                        <?php
                                            ...
                                            while($row2 = mysqli_fetch_array($result2)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center>₹ <?php echo number_format($row2['demo_tds'],2);?></center></td>
                                                    <td><center>₹ <?php echo number_format($row2['current_tds'],2);?></center></td>
                                                    <td><center>₹ <?php echo number_format($row2['demo_tds']-$row2['current_tds'],2);?></center></td>
