									...
									<tbody>
										<?php
											if($s1 != "")
											{
												if($s2 != "")
												{
													$sql1 = "SELECT * FROM enquiry WHERE qstatus='$status' AND stage='$stage' AND new_status='1' ORDER BY id DESC";
												}
												else
												{
													$sql1 = "SELECT * FROM enquiry WHERE qstatus='$status' AND new_status='1' ORDER BY id DESC";
												}
											}
											else
											{
												if($s2 != "")
												{
													$sql1 = "SELECT * FROM enquiry WHERE stage='$stage' AND new_status='1' ORDER BY id DESC";
												}
												else
												{
													$sql1 = "SELECT * FROM enquiry WHERE new_status='1' ORDER BY id DESC";
												}
											}
											...
											while($row1 = $result1->fetch_assoc())
											{
												...
												if($row1['sub_date'] != null && $row1['qstatus'] !="NOT SUBMITTED")
												{
													echo '<td><center>'.date('d-m-Y', strtotime($row1['sub_date'])).'</center></td>';
												}else{
													if($row1['qstatus'] !="NOT SUBMITTED")
													{
														echo '<td><center>'.date('d-m-Y', $date).'</center></td>';
													}else{
												...
												<td>
													<table class="action">
														<tr>
															...
															<td style="border: none;">
															<a href="edit-rfq.php?id=<?php echo $row1["id"]; ?>" title="Edit RFQ ID">
															<span class="notification-icon dashbg-green">
															<i class="fa fa-edit" aria-hidden="true"></i>
															</span>
															</a>
