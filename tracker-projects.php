                    	        ...
                    	        <table id="dataTableExample1" class="table table-striped">
                                    <thead>
                                        <tr>
											...
											<th style="border-bottom:  1px solid #cecece">PO Value</th>
											<th style="border-bottom:  1px solid #cecece">Invoiced Value</th>
											<th style="border-bottom:  1px solid #cecece">Collected Value</th>
											<th style="border-bottom:  1px solid #cecece">Yet To Invoice</th>
											<th style="border-bottom:  1px solid #cecece">Outstanding Value</th>
											<?php
											...
											<th rowspan="2">Invoice Count</th>
											<th rowspan="2">Invoice Month</th>
											<th rowspan="2">Action</th>
											<?php
												}
											?>
									...
									<tbody>
										<?php
											...
											while($row = $result->fetch_assoc())
											{
												...
												$invoiceTrakerTable = $result4->fetch_assoc();
												...
												// }
													...
													echo '<td><center>'.$p_scope.'</center></td>';
													...
													// echo '<td><center>SAR '.number_format($total,2).'</center></td>';

													$sql2 = "SELECT sum(demo) as current,sum(demo_gst) AS current_gst FROM invoice WHERE pid='$proid'";
													$result2 = $conn->query($sql2);
													$row2 = $result2->fetch_assoc();
													...
													// echo '<td><center>SAR '.number_format($row2["current"],2).'</center></td>';
													// echo '<td><center>SAR '.number_format($row3["current"],2).'</center></td>';
													// echo '<td><center>SAR '.number_format($total-$row2["current"],2).'</center></td>';
													// echo '<td><center>SAR '.number_format($row2["current"] - $row3["current"],2).'</center></td>';
											...
											?>
													...
													<td>
														<input type="number" id="<?php echo $pid;?>" class="form-control" value="<?php echo $invoiceTrakerTable['invoice_count'];?>" style="<?php echo $display;?>">
													</td>
													<td>
														<input type="date" id="date<?php echo $pid;?>" class="form-control" value="<?php echo $invoiceTrakerTable['date'];?>" style="<?php echo $display;?>">
													</td>
													<td>
