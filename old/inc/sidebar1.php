				...
				<ul>
					<li>
						<a href="dashboard.php" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/dashboard.png"></span>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/enquiry.png"></span>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/client.png"></span>
                    ...
                    <li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/projects.png"></span>
		                	<span class="ttr-label">Projects</span>
		                	<span class="ttr-arrow-icon"><i class="fa fa-caret-down"></i></span>
		                </a>
		                <ul>
							<li>
		                		<a href="all-projects.php" class="ttr-material-button"><span class="ttr-label">View All Projects</span></a>
		                	</li>
		                </ul>
		            </li>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/invoice.png"></span>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/account.png"></span>
		                ...
		                <ul>
							...
							<li>
		                		<a href="statement.php?id=4" class="ttr-material-button"><span class="ttr-label">Laser Scanning Services</span></a>
		                	</li>
		                </ul>
		            </li>
					...
					<li>
						<a href="#" class="ttr-material-button">
							<span class="ttr-icon"><img src="../projectmgmttool/assets/images/icon/report.png"></span>
