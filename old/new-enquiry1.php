<?php
    ...
    if(isset($_POST['save']))
    {
		...
		$sql = "INSERT INTO enquiry (rfq,rfqid,name,location,enqdate,stage,cname,responsibility,qstatus,qdatec,qdate,revision,notes,division) VALUES ('$rfq','$rfqid','$name','$location','$enqdate','$stage','$cname','$responsibility','$qstatus','$qdatec','$qdate','$revision','$notes','$division')";
								...
								<div class="" >
									<div class="">
										<div class="row" style="border-top: 1px solid rgba(0,0,0,0.05);padding: 20px;">
											...
											<div class="col-sm-1">
												<input type="submit" name="save" class="btn" value="Save" onclick="return dates()">
											</div>
										</div>
									</div>
								</div>
