                    ...
                    <div class="widget-box">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h5 style="float: right">₹ <?php echo number_format($total) ?></h5>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><center>₹ <?php echo number_format($su) ?></center></td>
                                                </tr>
                                        <?php
                                            }
                                            if($en != 0)
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><center>₹ <?php echo number_format($en) ?></center></td>
                                                </tr>
                                        <?php
                                            }
                                            if($si != 0)
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><center>₹ <?php echo number_format($si) ?></center></td>
                                                </tr>
                                        <?php
                                            }
                                            if($de != 0)
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><center>₹ <?php echo number_format($de) ?></center></td>
                                                </tr>
                                        <?php
                                            }
                                        ?>
