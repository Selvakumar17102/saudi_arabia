				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b30 m-t30">
                    <div class="widget-box">
						<div class="card-header">
							<div class="row">
								<div class="col-sm-4">
									<h4 class="float-left">Total Invoiced Value : QAR <?php echo number_format($st + $et + $sat + $envt + $acot + $lst,2) ?></h4>
								</div>
								<div class="col-sm-4">
									<center><h4>Division Wise Invoice Report</h4></center>
								</div>
								<div class="col-sm-4">
									<h4 class="float-right">Total Collected Value : QAR <?php echo number_format($sp + $ep + $sap + $envp + $acop + $lsp,2) ?></h4>
								</div>
							</div>
						</div>
						<div class="widget-inner">
                    	        ...
                    	        <table id="dataTableExample4" class="table table-striped">
									...
									<tbody>
											...
											<tr>
												...
												<td><center>ENVIRONMENTAL</center></td>
												<td><center>QAR <?php echo number_format($envt,2) ?></center></td>
												<td><center>QAR <?php echo number_format($envp,2) ?></center></td>
											</tr>
											<tr>
												<td><center> 5 </center></td>
												<td><center>ACOUSTICS</center></td>
												<td><center>QAR <?php echo number_format($acot,2) ?></center></td>
												<td><center>QAR <?php echo number_format($acop,2) ?></center></td>
											</tr>
											<tr>
												<td><center> 6 </center></td>
												<td><center>LASER SCANNING</center></td>
												<td><center>QAR <?php echo number_format($lst,2) ?></center></td>
												<td><center>QAR <?php echo number_format($lsp,2) ?></center></td>
											</tr>
