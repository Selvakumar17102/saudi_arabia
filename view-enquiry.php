...
<body class="ttr-pinned-sidebar">
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
					...
					<div class="widget-box">
						...
						<p style="text-align: center; color: green;"><?php echo $_REQUEST['msg']; ?></p>
							<form class="edit-profile m-b30" method="post" enctype="multipart/form-data">
								...
								<?php
									$sql3 = "SELECT * FROM project WHERE eid='$id'";
									...
									if($result3->num_rows > 0)
									{
										...
										?>
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input class="form-control" value="<?php echo $row3["proid"] ?>" type="text" readonly>
												</div>
											</div>
										<?php
									}
								?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input class="form-control" value="<?php echo $scope ?>" type="text" readonly>
										</div>
			...
			<?php
			$control_sql = "SELECT * FROM login WHERE username = '$user'";
			$control_result  = $conn->query($control_sql);
			$control_row = mysqli_fetch_array($control_result);

				if($control_row['designation'] == 1)
				{
			?>
			<div class="row">
				<div class="col-lg-12 m-b30">
