	...
	<div class="ttr-header-wrapper">
		...
		<div id="h1" class="ttr-header-menu">
			...
			<ul class="ttr-header-navigation">
				<li>
					<a href="dashboard.php" class="ttr-material-button ttr-submenu-toggle">Dashboard</a>
                </li>
                <li>
				...
				<li>
					...
					<div class="ttr-header-submenu">
						<ul>
							...
							<li><a href="credits.php">Invoice</a></li> -->
						</ul>
					</div>
				</li>
				<li>
					...
					<div class="ttr-header-submenu">
						<ul>
							...
							<li><a href="credit-report.php">Invoice</a></li>
		...
		<div id="h2" class="ttr-header-right ttr-with-seperator">
			...
			<ul class="ttr-header-navigation">
				<li>
					<a style="color:#fff" class="ttr-material-button ttr-search-toggle">Total: SAR <?php echo number_format($bank1+$bank2+$bank3+$cash,2) ?> <span style="font-size: 12px"></span></a>
				</li>
				<?php
					if($user == "bazeeth@123")
					{
						?>
							<li>
								<a href="#" style="color:#fff" class="ttr-material-button ttr-search-toggle">In Bank: SAR <?php echo number_format($bank1+$bank2+$bank3,2) ?> <span style="font-size: 12px"></span> <i class="fa fa-angle-down"></i></a>
								<div class="ttr-header-submenu">
									<ul>
										<li><a>In MHQ : SAR <?php echo number_format($bank1,2) ?> <span style="font-size: 12px"></span></a></li>
				...
				?>
				<li>
					<a style="color:#fff" class="ttr-material-button ttr-search-toggle">In Hand: SAR <?php echo number_format($cash,2) ?> <span style="font-size: 12px"></span></a>
				</li>
				<li>
					<a href="logout.php" class="ttr-material-button">Logout</a>
				</li>
			</ul>
		</div>
	</div>
