				...
				else
				{
					...
					else
					{
						...
						if($mode == "Cash")
						{
							...
							$cashbalance = $row1["balance"] - $debit;

							$sql2 = "UPDATE expence_main SET balance='$cashbalance' WHERE id='1'";
							if($conn->query($sql2) === TRUE)
							{
								$sql4 = "SELECT * FROM expence_invoice ORDER BY id DESC LIMIT 1";
								...
								if($recep == "Yes")
								{
									...
									$resumename = "Receipt/".$id.".".$resumetype;
									...
									if(!$resumename1=="")
									{
										if(in_array($resumetype, $allowTypes))
										{
											...
											{
												$sql1 = "INSERT INTO expence_invoice (code,mode,debit,descrip,date,type,chno,receipt,file) VALUES ('$code','$mode','$debit','$descrip','$date','2','$chno','$recep','$resumename')";
												if($conn->query($sql1) === TRUE)
												{
													...
													for($i=0;$i<$countdivi;$i++)
													{
														...
														{
															header("location: expence.php?date=$date&msg=Day Book Updated!");
														}
													}
												}
											}
									...
									{
										$sql1 = "INSERT INTO expence_invoice (code,mode,debit,descrip,date,type,chno,receipt) VALUES ('$code','$mode','$debit','$descrip','$date','2','$chno','$recep')";
										if($conn->query($sql1) === TRUE)
										{
											$sql4 = "SELECT * FROM expence_invoice ORDER BY id DESC LIMIT 1";
											$result4 = $conn->query($sql4);
						...
						else
						{
							...
							if($conn->query($sql2) === TRUE)
							{
								$sql1 = "INSERT INTO expence_invoice (code,mode,debit,descrip,date,type,chno,bank) VALUES ('$code','$mode','$debit','$descrip','$date','2','$chno','$banktype')";
								if($conn->query($sql1) === TRUE)
								{
									$sql4 = "SELECT * FROM expence_invoice WHERE code='$code' AND mode='$mode' AND debit='$debit' AND descrip='$descrip' AND date='$date' AND type='2'";
									$result4 = $conn->query($sql4);
									$row4 = $result4->fetch_assoc();
...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Day Book Expense | Income Expense Manager" />
	
	<!-- OG -->
	<meta property="og:title" content="Day Book ExpenseAccount | Income Expense Manager" />
	<meta property="og:description" content="Day Book Expense Account | Income Expense Manager" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Day Book Expense | Income Expense Manager</title>
									...
									<table id="dataTableExample1" class="table table-bordered table-striped table-hover">
										...
										<tbody>
											<?php
												...
												{
													$sql2 = "SELECT sum(credit) as credit,sum(debit) as debit FROM expence_invoice WHERE date='$fdate' AND type='2'";
											...
											?>
												<tr>
													...
													<td><center><a href="expence.php?date=<?php echo $fdate ?>" target="_blank"><?php echo date('d-m-Y',strtotime($fdate)) ?></a></center></td>
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="row" style="margin-bottom:20px;">
											...
											<div class="col-sm-3">
													<input class="form-control" type="date" name="date" value="<?php echo $dateid ?>" >
												...
												<div class="dublicat-box mrg-bot-40"> -->
													<div class="row">
														<div class="col-md-4 d">
															...
															<div>
																<select class="form-control" id="code" name="code" onchange="gets(this.value)">
																	...
																	<?php
																		$sql = "SELECT * FROM account WHERE type='1' AND sub='0'";
														...
														<div class="col-md-4 d">
															...
															<div class="divii">
																<select name="divi[]" class="form-control selectpicker" multiple data-style="btn-info" data-live-search="true">
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
									...
									<tbody>
                                        <?php
                                            $sql2 = "SELECT * FROM expence_invoice WHERE date='$dateid' AND debit!='0' AND type='2' ORDER BY id DESC";
                                            $result2 = $conn->query($sql2);
                                            $count = 1;
                                        ...
                                        ?>
                                            <tr>
												...
												<td>
													<center>
														<a href="edit-expence.php?id=<?php echo $row2["id"] ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
														<a href="delete-expence.php?id=<?php echo $row2["id"] ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
													</center>
												</td>
