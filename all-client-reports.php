									...
									<tbody>
										<?php
                                            ...
                                            while($row1 = $result1->fetch_assoc())
                                            {
                                                ...
                                                $temparray = array();
                                                $sql2 = "SELECT rfqid FROM enquiry WHERE cname='$cname'";
                                                $result2 = $conn->query($sql2);
                                                while($row2 = $result2->fetch_assoc())
                                                {
                                                    $rfqid1 = substr($row2["rfqid"], 0, -3);
                                                ...
                                                while($row3 = $result3->fetch_assoc())
                                                {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><center><?php echo $row3["cp"] ?></center></td>
                                                            <td><center><?php echo $row3["cpd"] ?></center></td>
                                                            <td><center><?php echo $row3["pn"] ?></center></td>
                                                            <td><center><?php echo $row3["ln"] ?></center></td>
                                                            <td><center><?php echo $row3["email"] ?></center></td>
                                                            <td><center><?php echo $row3["add1"] ?></center></td>
                                                        </tr>
                                                    <?php
                                                }
                                        ?>
