<?php
    ...
    if(isset($_POST["save"]))
    {
		...
		$sql = "INSERT INTO scope_list (divi,scope,sub_divi,gst) VALUES ('$divi','$scope','$sub_divi','$gst_percentage')";
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Add Scope | Project Management System</title>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row r-p100">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title">Add Scope</h4>
					</div>
					<div class="col-sm-1">
							...
							<form class="edit-profile" method="post" enctype="multipart/form-data">
								<div class="m-b30">
									...
									<div class="row">
										...
										<div class="col-sm-4">
                                            <input type="text" name="scope" class="form-control" placeholder="Enter Scope Name" required>
										</div>
