    ...
    if(isset($_POST['save']))
    {
		...
		if($scope_type == 0)
		{
			...
			if($conn->query($sql1) === TRUE)
			{
				while($row = $result->fetch_assoc())
				{
					...
					$sql2 = "INSERT INTO project (eid,logo,subdivi,finalq,value,pterms,noofm,status,nostatus,scope,proid,divi,dept,scope_type,invdues,po_status) VALUES ('$id','$logo','$type','$finalq','$value','$pterm','$noofm','$status','1','$sid','$projid','$divi','$dept','2','$invdues','$po_status')";
		...
		else
		{
			...
			if($conn->query($sql1) === TRUE)
			{
				...
				$sql2 = "INSERT INTO project (eid,logo,subdivi,finalq,value,pterms,noofm,status,nostatus,scope,proid,divi,scope_type,po_status) VALUES ('$id','$logo','$type','$finalq','$value','$pterm','$noofm','$status','1','$scope_id','$projid','$divi','1','$po_status')";
				if($conn->query($sql2) === TRUE)
				{
					$sql3 = "SELECT * FROM invoice";
					$result3 = $conn->query($sql3);
							...
							<form class="edit-profile m-b30" method="post" enctype="multipart/form-data">
								<div class="m-b30">
									...
									<div class="form-group row m-b30 m-t30">
										...
										<div class="col-sm-4">
											<input class="form-control" type="text" name="invdues" placeholder="Payment dues" value="<?php echo $invdues1 ?>">
										</div>
