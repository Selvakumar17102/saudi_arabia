<?php
	...
	if($id == "")
	{
		...
		$monthName = "Uninvoiced Projects for 60 Days";
	}
	else
	{
		if($id < 10)
		...
		<div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="widget-box">
                        <div class="card-header">
                            <center><h6>Monthly Projects</h6></center>
                        </div>
                        <div class="widget-inner">
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
                                            $sql = "SELECT * FROM project WHERE pterms='2' AND status='Commercially Open'";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>QAR <?php echo number_format($demo,2) ?></td>
                                                    <td>QAR <?php echo number_format($current,2) ?></td>
                                                    <td>QAR <?php echo number_format($yet,2) ?></td>
                                                    <td>QAR <?php echo number_format($demo - $current,2) ?></td>
                                                    <?php
												if($rowside["id"] != 2)
												{
											?>
                                                    <td><center><a href="invoice.php?id=<?php echo $row["id"] ?>" title="Next"><span class="notification-icon dashbg-yellow"><i class="fa fa-arrow-right" aria-hidden="true"></i></span></a></center></td>
                                                    <?php
                                                        }
                                                    ?>
                                                </tr>
            ...
            <div class="row m-b30">
                <div class="col-sm-12">
                    <div class="widget-box">
                        <div class="card-header">
                            <center><h6>Milestone Projects</h6></center>
                        </div>
                        <div class="widget-inner">
                            <div class="table-responsive">
                    	        <table id="dataTableExample2" class="table table-striped">
									...
									<tbody>
                                        <?php
                                            $sql = "SELECT * FROM project WHERE pterms='1' AND status='Commercially Open'";
                                            $result = $conn->query($sql);
                                            $count = 1;
                                            while($row = $result->fetch_assoc())
                                            {
            ...
            <div class="row m-b30">
                <div class="col-sm-12">
                    <div class="widget-box">
                        <div class="card-header">
                            <center><h6>Prorata Projects</h6></center>
                        </div>
                        <div class="widget-inner">
                            <div class="table-responsive">
                    	        <table id="dataTableExample3" class="table table-striped">
									...
									<tbody>
                                        <?php
                                            $sql = "SELECT * FROM project WHERE pterms='3' AND status='Commercially Open'";
                                            $result = $conn->query($sql);
                                            $count = 1;
                                            while($row = $result->fetch_assoc())
                                            {
