	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				...
				<div class="col-sm-10">
                        <h4 class="breadcrumb-title" style="text-align: center;color: #214597;font-size: 30px;font-weight: bold;padding-left:250px;"><center><h4>Project wise TDS breakup  </h4></center></h4>
					</div>
                                            ...
                                            while($row_pro = mysqli_fetch_array($result2)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center><?php echo $row_pro['proid'];?></center></td>
                                                        ...
                                                        ?>
                                                    <td><center><a href="tds_project_reports.php?project=<?php echo $pro_name_row['id'];?>"><?php echo $pro_name_row['name'];?></a></center></td>
                                                    <?php
                                                        $total_gst_sql = "SELECT sum(demo_tds) AS total_tds,sum(current_tds) AS resived_tds  FROM invoice WHERE pid = '".$row_pro['proid']."' AND paystatus !='0'";
                                                        $total_gst_result   = $conn->query($total_gst_sql);
                                                        $total_gst_row      = mysqli_fetch_array($total_gst_result);
                                                        // echo number_format($total_gst_row['total_gst'],2);
                                                    ?>
                                                    <td><center>₹ <?php echo number_format($total_gst_row['total_tds'],2);?></center></td>
                                                    <td><center>₹ <?php echo number_format($total_gst_row['resived_tds'],2);?></center></td>
                                                    <td><center>₹ <?php echo number_format($total_gst_row['total_tds']-$total_gst_row['resived_tds'],2);?></center></td>
                                                </tr>
                                                <?php
                                            }
                                        ?>
