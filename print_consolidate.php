	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="row m-b30">
				...
				<div class="col-sm-1"><a href="consolidate.php?division=<?php echo $division; ?>&s_date=<?php echo $s_date; ?>&e_date=<?php echo $e_date; ?>&type=<?php echo $type; ?>" style="color: #fff" class="bg-primary btn">Back</a></div>
			</div>
                                ...
                                <table id="dataTableExample1" class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Collected VAT Value</th>
                                            <th>Yet To Invoice Value</th>
                                            <th>Yet To Invoice VAT Value</th>
                                            <th>Outstanding Value</th>
                                            <th>Outstanding VAT Value</th>
                                    ...
                                    <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['subdivi'];?></td>
                                                <td><?php echo $row["proid"];?></td>
                                                <td><?php echo $row1["name"];?></td>
                                                <td><?php echo $row11["cname"];?></td>
                                                <td><?php echo $s;?></td>
                                                <td><?php echo $row1['responsibility'];?></td>
                                                    <?php 
                                                ...
                                                <td><?php echo number_format($search_invoice_value,2);?></td>
                                                <td><?php echo number_format($search_invoice_vat,2);?></td>
                                                <td><?php echo number_format($search_collected_value,2);?></td>
                                                <td><?php echo number_format($search_collected_vat,2);?></td>
                                                <td><?php echo number_format($total - $search_invoice_value,2);?></td>
                                                <td><?php echo number_format($total_vat - $search_invoice_vat,2);?></td>
                                                <td><?php echo number_format($search_invoice_value - $search_collected_value,2);?></td>
                                                <td><?php echo number_format($search_invoice_vat - $search_collected_vat,2);?></td>
