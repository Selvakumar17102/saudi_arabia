<?php
	...
	if($div == "")
	{
		$sql1 = "SELECT * FROM enquiry WHERE qstatus='$qst' AND pstatus='$pst' AND new_status='1'";
	}
	else
	{
		if($stage == "")
		{
			$sql1 = "SELECT * FROM enquiry WHERE division='$div' AND qstatus='$qst' AND pstatus='$pst' AND new_status='1'";
		}
		else
		{
			$sql1 = "SELECT * FROM enquiry WHERE division='$div' AND stage='$stage' AND qstatus='$qst' AND pstatus='$pst'";
		}
	}
...
<body class="ttr-opened-sidebar1 ttr-pinned-sidebar">
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<div class="row r-p100">
					<div class="col-sm-11">
						<h4 class="breadcrumb-title">Lost Enquiries</h4>
					</div>
					<div class="col-sm-1">
