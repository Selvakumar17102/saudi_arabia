...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Unregistered Projects | Project Management</title>
		...
		<div class="container-fluid">
			<div class="db-breadcrumb">
				...
				<ul class="db-breadcrumb-list">
					...
					<li>All Unregistered Projects</li>
				</ul>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
											$sql1 = "SELECT * FROM enquiry WHERE qstatus='SUBMITTED' AND pstatus='AWARDED'";
											...
											while($row1 = $result1->fetch_assoc())
											{
                                                ...
                                                if($result->num_rows == 0)
                                                {
                                                    ...
                                                    echo '<td><center><a style="padding:10px" href="new-project.php?id='.$row1["id"].'"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></center></td>';
                                                    echo '</tr>';
                                                    $count++;
                                                }
											}
