...
<body class="ttr-pinned-sidebar">
                        ...
                        <div class="widget-box">
                            <div class="widget-inner">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <div class="col-sm-1">
                                        <button id="button" class="btn" onclick="htmlTableToExcel('xlsx')">EXCEL</button>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table id="tblToExcl" style="border: 1px solid black;">
                                        <tbody>
 ...
 XLSX.writeFile(excelFile, 'invoice-tracker:Excel.' + type);
}
    </script>
</body>
