		...
		<div class="container-fluid">
			...
			<div class="row head-count m-b30">
				<div class="col-lg-6">
					...
					<a href="commercially-open.php?type=<?php echo $id;?>&report_type=1&divi=<?php echo $division;?>" title="Commercially Open Projects"><div class="widget-card widget-bg2">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Commercially Open
							</h4>
							<span class="wc-stats">
								<?php 
									if($division == "")
									{
										$tend1 = "SELECT * FROM project where status = 'Commercially Open' AND pterms='$id'";
									}else{
										$tend1 = "SELECT * FROM project where status = 'Commercially Open' AND divi='$division' AND pterms='$id'";
									}
				...
				<div class="col-lg-6">
					<a href="monthly-invoice.php?ids=2&id=<?php echo $id ?>" title="Project Closed"><div class="widget-card widget-bg3">					 
						<div class="wc-item">
							<h4 class="wc-title">
								Monthly Invoice
							</h4>
							<span class="wc-stats">
								<?php
									if($division == "")
									{
										$jobin1 = "SELECT * FROM project where status = 'Commercially Open' AND pterms='$id' AND inv='0'";
									}else{
										$jobin1 = "SELECT * FROM project where status = 'Commercially Open' AND divi='$division' AND pterms='$id' AND inv='0'";
									}
			...
			<div class="row">
				<?php
					...
					else
					{
						if($division =="")
						{
							$sql = "SELECT * FROM project WHERE pterms='$id' AND status = 'Commercially Open' ORDER BY id DESC";
						}else{
							$sql = "SELECT * FROM project WHERE pterms='$id' AND divi='$division' AND status = 'Commercially Open' ORDER BY id DESC";
						}
					}
									...
									<tbody>
										<?php
											if($ids != "")
											{
												if($division == "")
												{
													$sql = "SELECT * FROM project WHERE pterms='$id' AND status='$test1' AND status = 'Commercially Open' ORDER BY id DESC";
												}else{
													$sql = "SELECT * FROM project WHERE pterms='$id' AND status='$test1' AND divi='$division' AND status = 'Commercially Open' ORDER BY id DESC";
												}
											}
											else
											{
