                    	        ...
                    	        <table id="dataTableExample1" class="table table-striped">
									...
									<tbody>
										<?php
											...
											{
												$sql1 = "SELECT * FROM enquiry WHERE qstatus = 'DROPPED' AND new_status='1' ORDER BY enqdate DESC";
											}else{
												$sql1 = "SELECT * FROM enquiry WHERE qstatus = 'DROPPED' AND new_status='1' AND enqdate BETWEEN '$start_date' AND '$end_date' ORDER BY enqdate DESC";
											}
